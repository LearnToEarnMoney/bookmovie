...
const numberOfUpcomingMovies = 6;
...
class Home extends Component {
    ...
    componentWillMount() {
        ...
        xhrReleased.send(releasedMovieData);
    ...
    render() {
        ...
        return (
            <div>
                ...
                <GridList cols={numberOfUpcomingMovies} className={classes.gridListUpcomingMovies} >
